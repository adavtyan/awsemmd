...
#ifndef FIX_BACKBONE_H
#define FIX_BACKBONE_H
...
public:
  ...
  int *periodicity;
  bool chain_flag, shake_flag, chi_flag, rama_flag, rama_p_flag, excluded_flag, p_excluded_flag, r6_excluded_flag, ssweight_flag;
  bool dssp_hdrgn_flag, p_ap_flag, water_flag, burial_flag, helix_flag;
...
//  friend template <typename T, typename U> class cP_AP;
